		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getHeaderAccess().getNameAlternatives_2_0(), "rule__Header__NameAlternatives_2_0");
					...
					put(grammarAccess.getAnAccess().getIdNodeAlternatives_1_0(), "rule__An__IdNodeAlternatives_1_0");
					put(grammarAccess.getCnAccess().getIdNodeAlternatives_1_0(), "rule__Cn__IdNodeAlternatives_1_0");
					put(grammarAccess.getDnAccess().getIdNodeAlternatives_1_0(), "rule__Dn__IdNodeAlternatives_1_0");
					put(grammarAccess.getAeAccess().getIdEdgeAlternatives_1_0(), "rule__Ae__IdEdgeAlternatives_1_0");
					put(grammarAccess.getAeAccess().getIdNode1Alternatives_2_0(), "rule__Ae__IdNode1Alternatives_2_0");
					put(grammarAccess.getAeAccess().getIdNode2Alternatives_4_0(), "rule__Ae__IdNode2Alternatives_4_0");
					put(grammarAccess.getCeAccess().getIdNodeAlternatives_1_0(), "rule__Ce__IdNodeAlternatives_1_0");
					put(grammarAccess.getDeAccess().getIdEdgeAlternatives_1_0(), "rule__De__IdEdgeAlternatives_1_0");
					put(grammarAccess.getAttributeAccess().getAlternatives_0(), "rule__Attribute__Alternatives_0");
					put(grammarAccess.getAttributeAccess().getIdAttributeAlternatives_1_0(), "rule__Attribute__IdAttributeAlternatives_1_0");
					put(grammarAccess.getValueAccess().getAlternatives(), "rule__Value__Alternatives");
					put(grammarAccess.getMappingAccess().getIdAlternatives_0_0(), "rule__Mapping__IdAlternatives_0_0");
					...
					put(grammarAccess.getCeAccess().getIdNodeAssignment_1(), "rule__Ce__IdNodeAssignment_1");
					...
					put(grammarAccess.getValueAccess().getMapAssignment_3(), "rule__Value__MapAssignment_3");
